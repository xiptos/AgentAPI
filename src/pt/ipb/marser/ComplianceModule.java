/*
 * $Id: ComplianceModule.java 3 2004-08-03 10:42:11Z rlopes $
...
public class ComplianceModule {
  ...
  public ComplianceModule(String id) {
    setModuleId(id);
  }
  ...
  public void addComplianceObject(ComplianceObject complianceObject) {
    complianceObjects.add(complianceObject);
  }

  public void addComplianceGroup(ComplianceGroup complianceGroup) {
    complianceGroups.add(complianceGroup);
  }
  ...
  public Enumeration complianceObjects() {
    return complianceObjects.elements();
  }

  public Enumeration complianceGroups() {
    return complianceGroups.elements();
  }
